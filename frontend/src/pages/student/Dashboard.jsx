...
import { CheckSquare, Bookmark, Users2, Award, Sparkles, ArrowRight } from 'lucide-react';
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
          <div className="space-y-6 xl:col-span-2">
            ...
            {/* AI Placement Intelligence Banner Card */}
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-brand-600 via-indigo-600 to-ink-900 p-6 text-white shadow-md">
              <div className="relative z-10 flex flex-wrap items-center justify-between gap-4">
                <div className="max-w-md">
                  ...
                  <h3 className="mt-2 text-lg font-bold">Smart Skill Gap & Learning Roadmap</h3>
                  <p className="mt-1 text-xs text-white/80 leading-relaxed">
                    Personalized insights: Why you're not eligible, how to become eligible, top missing skills, and your 4-week placement sprint roadmap.
                  </p>
                </div>
                <Link
                  to="/student/ai-skill-gap"
                  className="flex items-center gap-2 rounded-xl bg-white px-4 py-2.5 text-xs font-bold text-ink-900 shadow-sm transition hover:bg-gray-100"
                >
                  Explore Skill Gap <ArrowRight size={14} />
                </Link>
              </div>
            </div>
