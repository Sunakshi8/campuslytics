...
import AiSkillGapDashboard from './pages/student/AiSkillGapDashboard';
...
import AiRecruiterCopilot from './pages/company/AiRecruiterCopilot';
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<ProtectedRoute allowedRoles={['student']} />}>
          ...
          <Route path="/student/ai-skill-gap" element={<AiSkillGapDashboard />} />
        ...
        <Route element={<ProtectedRoute allowedRoles={['company']} />}>
          ...
          <Route path="/company/ai-copilot" element={<AiRecruiterCopilot role="company" />} />
        ...
        <Route element={<ProtectedRoute allowedRoles={['tpo']} />}>
          ...
          <Route path="/tpo/ai-copilot" element={<AiRecruiterCopilot role="tpo" />} />
